...
db = client.test
mydatabase = client['Flipkart']
mycollection=mydatabase['flip']
...
# mydb=conn.connect(host="localhost",user="root",password="12345678",database="Flipkart")
# print(mydb)
# cursor=mydb.cursor()
# dataBaseName="Flipkart"
    ...
    if request.method == "POST":
        ...
        try:
            ...
            for commentsB in commentboxes:
                ...
                mydict = {"Comment":custComment,'Name':name,'Price':price,"Comment_H":comment_h,"DateTime":date_time,"Name_P":name_p}
                print(mydict)
